...
import { fetchAddMemberCustomers, fetchCustomerNotification, addTeamMember } from '@/lib/api';
import { AddMemberCustomer, Notification, CustomerFilter, Role } from '@/types/types';

export default function AddMemberPage() {
  const [customers, setCustomers] = useState<AddMemberCustomer[]>([]);
  ...
  useEffect(() => {
    const loadData = async () => {
      const customerData = await fetchAddMemberCustomers(timeRange, filter);
