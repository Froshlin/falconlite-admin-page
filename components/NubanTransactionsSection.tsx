  ...
  return (
    <Card className="mb-4 border border-gray-[#8B9DA4] gap-0 py-0 shadow-none rounded-[29px]">
      ...
      <CardContent className='sm:px-0 px-1'>
        <div className="grid grid-cols-3 sm:gap-1 gap-0">
            ...
            <div key={index} className={`xl:px-4 px-1 pt-4 ${index !== data.categories.length - 1 ? 'border-r border-[#D3D3D3]' : ''}`}>
              ...
              <div>
                <div className="flex justify-between text-sm border-b border-[#D3D3D3] text-[#0E3B4C] py-1 pt-6">
                  <span className=" lg:text-[12px] text-[9px]">Amount</span>
                  <span className=" lg:text-[12px] text-[9px]">{category.amount}</span>
                </div>
                <div className="flex justify-between text-sm border-b border-[#D3D3D3] text-[#0E3B4C] py-1 pt-6">
                  <span className=" lg:text-[12px] text-[9px]">Charge</span>
                  <span className=" lg:text-[12px] text-[9px]">{category.charge}</span>
                </div>
                <div className="flex justify-between text-sm text-[#0E3B4C] pt-6 pb-8">
                  <span className=" lg:text-[12px] text-[9px]">Profit</span>
                  <span className=" lg:text-[12px] text-[9px] text-green-500">{category.profit}</span>
                </div>
              </div>
            </div>
          ))}
